...
while True:
    ...
    if time.time()-baslangic_zaman > random.randint(4, 7):
        ...
        engel.dx = random.randint(-160, 170)
        engel.dy = 525
        engel.goto(engel.dx, engel.dy)
    ...
    if engeller[i].distance(araba) < 45:
        hasar -= 1
        if hasar <= 0:
            skor = 0
            yaz.clear()
    ...
    if time.time()-baslangic_zaman1 > random.randint(3, 6):
        baslangic_zaman1 = time.time()
        
        engel1.dx = random.randint(-170, 150)
        engel1.dy = 575
        engel1.goto(engel1.dx, engel1.dy)
    ...
    if engeller1[ii].distance(araba) < 45:
        hasar -= 1
        if hasar <= 0:
            skor = 0
            yaz.clear()
    ...
    if skor >= lvl_2:
        ...
        if time.time()-baslangic_zaman2 > random.randint(3, 6):
            baslangic_zaman2 = time.time()
        ...
        if engeller2[iii].distance(araba) < 45:
            hasar -= 1
            if hasar <= 0:
                skor = 0
                yaz.clear()
    ...
    if skor >= lvl_3:
        ...
        if time.time()-baslangic_zaman3 > random.randint(3, 6):
            baslangic_zaman3 = time.time()
            engel3.dx = random.randint(-150, 170)
            engel3.dy = 550
            engel3.goto(engel3.dx, engel3.dy)
        ...
        if engeller3[iiii].distance(araba) < 45:
            hasar -= 1
            if hasar <= 0:
                skor = 0
                yaz.clear()
